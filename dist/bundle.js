...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return hijackers; });
/* harmony import */ var _history__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./history */ "./hijackers/history.js");
/* harmony import */ var _history__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_history__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _utils_sandbox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/sandbox */ "./utils/sandbox.js");
...
const init = function () {
  window.addEventListener('load', function (e) {
    Object(_utils_clearTemplate__WEBPACK_IMPORTED_MODULE_1__["default"])();
  });
};
...
/***/ "./node_modules/html-entry/esm/index.js":
/*!**********************************************!*\
  !*** ./node_modules/html-entry/esm/index.js ***!
  \**********************************************/
/*! exports provided: default, importEntry */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _process_tpl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./process-tpl */ "./node_modules/html-entry/esm/process-tpl.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./node_modules/html-entry/esm/utils.js");
  ...
  return _getExternalScripts(scripts).then(function (scriptsText) {
    ...
    function exec(scriptSrc, inlineScript, resolve) {
      ...
      if (scriptSrc === entry) {
        ...
        var exports = proxy[Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getGlobalProp"])()] || {};
        resolve(exports);
      } else {
        try {
          // bind window.proxy to change `this` reference in script
...
function importHTML(url) {
  return embedHTMLCache[url] || (embedHTMLCache[url] = fetch(url).then(function (response) {
    ...
    var _processTpl = Object(_process_tpl__WEBPACK_IMPORTED_MODULE_0__["default"])(html, getDomain(url)),
...
/***/ "./node_modules/html-entry/esm/process-tpl.js":
/*!****************************************************!*\
  !*** ./node_modules/html-entry/esm/process-tpl.js ***!
  \****************************************************/
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./node_modules/html-entry/esm/utils.js");
    ...
    */
    ...
    if (SCRIPT_TAG_REGEX.test(match)) {
      ...
      */
      ...
      var code = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getInlineCode"])(match); // remove script blocks when all of these lines are comments.
...
/***/ "./node_modules/html-entry/esm/utils.js":
/*!**********************************************!*\
  !*** ./node_modules/html-entry/esm/utils.js ***!
  \**********************************************/
/*! exports provided: getGlobalProp, noteGlobalProps, getInlineCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGlobalProp", function() { return getGlobalProp; });
...
/* harmony default export */ __webpack_exports__["default"] = (clearTemplate);
...
/* harmony import */ var _hijackers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hijackers */ "./hijackers/index.js");


function getSandbox(appName) {
